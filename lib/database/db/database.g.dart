    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Person` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `imei` TEXT, `firstName` TEXT, `lastName` TEXT, `birthOfDate` TEXT, `email` TEXT, `passport` TEXT, `image` TEXT, `latitute` REAL, `longitude` REAL, `deviceName` TEXT)');
